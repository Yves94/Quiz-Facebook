...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                {!! Form::open(['url' => 'admin/user/edit/'.$user->id_user,'method'=>'POST']) !!}
                ...
                <div class="form-group">
                    ...
                    <div class='input-group date datepicker'>
                        {!! Form::text('birthday',\DateTime::createFromFormat('Y-m-d', $user->birthday)->format('d/m/Y'), ['class' => 'form-control', 'placeholder' => '01/01/1990']) !!}
